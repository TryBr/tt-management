            ...
            <Row>
                <Col span={12}>
                        <Form layout={"vertical"} size={"middle"} onFinish={onFinish}> 
                            ...
                            <Form.Item label="Юридическая форма" name="legalForm" defaultValue={owner[id].legalForm}>
                                <Select>
                                    <Option value="physic">Физическое лицо</Option>
                            ...
                            <Form.Item label="Статус собственника" name="ownStatus" initialValue={owner[id].ownStatus}>
                                <Input />
                            </Form.Item>
