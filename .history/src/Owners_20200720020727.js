  ...
  render() {
    return (
      <Fragment>
                ...
                <Row>
                        ...
                        <Col span={8}>
                                <div className="select-wrapper">
                                        ...
                                        <Select className="select-filter" defaultValue="abc" suffixIcon={ <SelectIconPrefix /> }>
        ...
        <Table className="owners-table" dataSource={dataSource} columns={columns} showHeader={false} pagination={false} />
      </Fragment>
    );
  }
}
